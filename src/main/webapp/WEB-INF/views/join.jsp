...
<div id="wrap">
	<div id="join_content">
	<div class="subtitle">
        <h2><img src="http://cdn-bikeselling.bizhost.kr/img/member_join_frm.gif" width="230px;"></h2>
        <p>회원 가입하시면 바이크셀링 가족이 됩니다.^^</p>
    </div>
    <div id="join">
...
이벤트 등 광고성 정보 전달
개인정보의 보유 및 이용기간
바이크셀링은 원칙적으로 개인정보 수집 및 이용목적이 달성된 후에는 해당 정보를 지체 없이 파기합니다. 단, 상법 및 “전자상거래등에서의 소비자보호에 관한 법률” 등 관련 법령의 규정에 의하여 다음과 같이 거래 관련 관리 의무 관계의 확인 등을 이유로 일정기간 보유하여야 할 필요가 있을 경우에는 일정기간 보유합니다.
- 계약 또는 청약철회 등에 관한 기록 : 5년 (전자상거래등에서의 소비자보호에 관한 법률)
- 대금결제 및 재화 등의 공급에 관한 기록 : 5년 (전자상거래등에서의 소비자보호에 관한 법률)
- 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년 (전자상거래등에서의 소비자보호에 관한 법률)
- 설문조사, 이벤트 등 일시적 목적을 위하여 수집한 경우 : 당해 설문조사, 이벤트 등의 종료 시점
- 본인확인에 관한 기록 : 6개월(정보통신망 이용촉진 및 정보보호 등에 관한 법률)
- 방문(로그)에 관한 기록 : 3개월(통신비밀보호법)</textarea></p>
			        <p class="agree_p">이용약관과 개인정보보호방침에 <input type="radio" name="agree" value="Y">동의함 <input type="radio" name="agree" value="N">동의안함</p>
                <!-- 일반회원 기본 노출 -->
                ...
                <div id="personInfo">
                    ...
                    <table class="person-tb">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <th>
                                    <div class="tb-l pl-30"><span class="red">*</span> 연락처</div>
                                </th>
                                <td>
